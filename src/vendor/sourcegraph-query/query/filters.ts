 ...
 *           client/shared/src/search/query/filters.ts
 * Changed:  import specifiers rewritten; the utility-types Omit import was dropped in favour of the TypeScript builtin.
 *
