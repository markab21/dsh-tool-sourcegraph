 ...
 */
export type Token = Whitespace | OpeningParen | ClosingParen | Keyword | Comment | Literal | Pattern | Filter | Separator;
/**
...
export declare const createLiteral: (value: string, range: CharacterRange, quoted?: boolean, quotes?: string) => Literal;
